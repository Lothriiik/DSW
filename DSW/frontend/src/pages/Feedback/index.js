...
function Feedback() {
    ...
    dropdownTextRef.current.innerText = optionText;
                ...
                <form onSubmit={handleSubmit(onSubmit)} className={style["form"]}>
                    <div className={`${style["dropdown-menu"]} ${isActive ? style["active"] : ""}`}>
                        ...
                        {options.map((option, index) => (
                            <li key={index} className={style["option"]} ref={(el) => optionsRef.current[index] = el} 
                    ...
                    <div className={`${style["dropdown-menu"]} ${isActive2 ? style["active"] : ""}`}>
                        <label htmlFor="lecc" className={style["label"]}>Teria alguma ideia ou sugestão de melhoria?</label>
