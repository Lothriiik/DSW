...
const [isActive, setIsActive] = useState(false); //controlar se o menu está ativo
          ...
          <div className={style["conteiner"]}>
            <div className={style["conteiner01"]}>
              ...
              <div className={style["form-group"]}>
                <label htmlFor="numMaquina" className={style["label"]}>ID do dispositivo</label>
              ...
              <div className={style["form-group"]}>
                <label htmlFor="hardwareResp" className={style["label01"]}>Descreva com detalhes o problema se escolheu a opção "Sim" na resposta anterior</label>
            ...
            <div className={style["conteiner02"]}>
              ...
              <div className={style["form-group"]}>
                <label htmlFor="softwareResp" className={style["label01"]}>Descreva com detalhes o problema se escolheu a opção "Sim" na resposta anterior</label>
