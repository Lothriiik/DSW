...
import './styles.css';
import { fetchSalas, fetchDispositivosBySala, createObservacao } from '../../services/api';
...
function ObservacaoAdd() {
  ...
  const handleSave = async () => {
    try {
      ...
      await createObservacao(observacaoData);
  ...
  return (
    <>
      <div className='headerAdd'>
        <h1 className='headerTitleAdd'>Adicionar Observação</h1>
      </div>
