...
export default function CardLECC({ lab, sala, numdisp, onClickCard, onClickEdit, onClickDelete }) {
    const handleCardClick = (e) => {
        if (e.target.closest('.cardlecc-actions-buttons')) return;
        onClickCard();
    };
    ...
    return (
        <div className="cardlecc" onClick={handleCardClick}>
            ...
            <p className="textlecc-sala">{sala}</p>
            <p className="textlecc-dispositivos">Dispositivos: {numdisp}</p>
            <div className="cardlecc-actions-buttons">
                <Tooltip title='Editar'>
                    <button className="tam3424 blue" onClick={onClickEdit}>
                ...
                <Tooltip title='Deletar'>
                    <button className="tam3424 red" onClick={onClickDelete}>
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
