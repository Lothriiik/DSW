...
export default function CardObservacaoLab({sala, patrimonio, tipo, descricao, solicitante, observacao, data, onClickDeletar, onClickEditar}) {
    return (
                ...
                <div className="card-obs">
                    <div className='titlediv'>
                        ...
                        <p className="text-obs-solicitante">
                        {solicitante}
                        </p>
                    </div>
