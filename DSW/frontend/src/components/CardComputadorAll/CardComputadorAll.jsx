...
export default function CardComputadorAll({ tipo, patrimonio, descricao, status, data, sala,  onClickDeletar, onClickEditar, onClickCard}) {
    ...
    return (
                ...
                <div className="card-compall" onClick={handleCardClick}>
                    <div className='titlediv'>
                        <p className="text-compall-tipo">
                            <b>Tipo:</b> {tipo}
                        </p>
                        <p className="text-compall-sala">
                        {sala}
                        </p>
                    </div>
                    <p className="text-compall-patrimonio">
                        <b>Patrimônio:</b> {patrimonio} 
                    </p>

                    <p className="text-compall-descricao">
                        <b>Descrição:</b> {descricao}
                    </p>
                    <p className="text-compall-status">
                        <b>Status:</b> {status}
                    </p>
                    <p className="text-compall-data">
                        <b>Data de Verificação:</b> {data}
                    </p>
                    <div className="cardcompall-actions-buttons">
